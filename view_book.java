...
// Column Header
String[] columns = {"ID", "Name", "Author", "Publication", "Date" };
...
final String QUERY = "Select id , name , auther, publication, date from bookdata order by id asc";
try {
// Loading the Driver
...
data[i][j++] = rs.getString("auther");
data[i][j++] = rs.getString("publication");
data[i][j++] = rs.getDate("date");
